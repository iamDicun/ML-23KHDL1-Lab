...
class PolarityMapping:
    ...
    # Alternative mappings retained for reference
...
class VLSP2018Loader:
    ...
    def labels_to_flatten_onehot(datasets):
        ...
        def transform_each_review(review): # Convert each Aspect#Category/Polarity to one-hot encoding and flatten
            ...
            ], []) # Flatten to match the model output shape
            return review 
